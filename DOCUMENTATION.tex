...
\label{sec:orgf420eda}
\subsection{Problem Statement}
\label{sec:orgf40a9c6}
\begin{itemize}
...
\label{sec:org58316f2}
\subsubsection{anki}
\label{sec:org73a9c66}
\begin{center}
\begin{tabular}{ll}
Aspect & Anki\\
\hline
...
\label{sec:org15a39e4}
\subsection{Project State \& Scope}
\label{sec:orgdded263}
...
\label{sec:orga77d1cf}
\subsubsection{versions @10jul2026}
\label{sec:org3c907d9}
\begin{center}
\begin{tabular}{ll}
Technology & Version\\
\hline
...
\label{sec:orge2f280f}
\subsubsection{Core Deck Management}
\label{sec:org0180ba3}
\begin{itemize}
...
\label{sec:org01b08b3}
\subsection{System Architecture}
\label{sec:org7cab4d0}
...
\label{sec:org64a02e3}
\subsubsection{Use Case Diagram}
\label{sec:orgaecf072}
\begin{center}
...
\label{sec:org2d638be}
\subsection{Unit Test Framework}
\label{sec:org5f4d9b8}
...
\label{sec:orgc825350}
\subsection{Logo \& Branding}
\label{sec:orgb42e83a}
\begin{center}
...
\label{sec:orgc3f0f55}
\subsubsection{Home \& Navigation}
\label{sec:org1d40fa7}
\begin{center}
...
\label{sec:org1203de6}
\subsection{Linux WebView Constraint}
\label{sec:org007ce1f}
\begin{itemize}
...
\label{sec:org4f46633}
\subsection{Conclusion}
\label{sec:orgebe22f2}
\begin{center}
...
\label{sec:orgcdbe042}
\subsection{Technology References}
\label{sec:org81de16a}
\begin{itemize}
...
\label{sec:orgc70d883}
\subsection{License}
\label{sec:orgb8d616c}
